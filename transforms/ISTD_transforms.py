...
class Compose(object):
  ...
  def __call__(self, imgs):
    # imgA, imgB, imgC = imgs['imgA'], imgs['imgB'], imgs['imgC']
...
class ToTensor(object):
  ...
  def __call__(self, imgs):
    ...
    for pic in pics:
      ...
      output.append(img)
    return {'imgA':output[0], 'imgB':output[1], 'imgC':output[2]}
...
class Normalize(object):
  ...
  def __call__(self, imgs):
    tensorA, tensorB, tensorC = imgs['imgA'], imgs['imgB'], imgs['imgC']
